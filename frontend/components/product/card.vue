...
<template>
    <div class="relative">
        <div class="relative flex items-center justify-center p-12 bg-gray-100 cursor-pointer group">
            <!-- Discount Badge -->
            ...
            <div>
                <NuxtLink to="/product/{id}">
                    <img :src="product.image" alt="Product Image" class="object-contain w-full h-40" />
                </NuxtLink>
            </div>
            ...
            <div class="absolute flex flex-col space-y-2 right-4 top-2">
                <button class="p-2 text-black bg-white rounded-full" @click="addToWishlist">
                    <Icon :name="whishList ? 'fluent:heart-28-filled' : 'fluent:heart-28-regular'"
